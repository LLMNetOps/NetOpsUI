...
from agents.nodes import (
    ...
    route_from_supervisor, security_node, supervisor_node, validasi_node,
)
...
def build_graph(checkpointer) -> object:
    ...
    builder.add_node("validasi_agent",  validasi_node)
    ...
    builder.add_conditional_edges(
        ...
        route_from_supervisor,
        {
            ...
            "validasi_agent": "validasi_agent",
            "END":            END,
        },
    )

    # All specialists report back to supervisor
    for agent in ("monitor_agent", "diagnose_agent", "config_agent", "security_agent",
                  "document_agent", "netbox_agent", "validasi_agent"):
